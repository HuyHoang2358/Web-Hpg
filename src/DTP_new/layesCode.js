...
function setupLayers() {
  ...
  addAdditionalLayerOption(
    ...
    Cesium.TileMapServiceImageryProvider.fromUrl('../images/cesium_maptiler/Cesium_Logo_Color'),
    0.2,
  );
  addAdditionalLayerOption(
    'Single Image',
...
async function addAdditionalLayerOption(name, imageryProviderPromise, alpha, show) {
  try {
    const imageryProvider = await Promise.resolve(imageryProviderPromise);
    const layer = new Cesium.ImageryLayer(imageryProvider);
